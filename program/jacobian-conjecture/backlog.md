...
| JCB-032 | The edge-residue functional in CLOSED FORM (from the EXP-028 anatomy: support on the P-edge ray, weight patterns (4a,-3) and (64a^3,-48a^2,40a,-35)); then evaluate beyond the ~108 floor (gcd 45 at (90,135)): a statement nobody has verified in any form | P5 | todo | 2026-07-21 | the new instrument |
