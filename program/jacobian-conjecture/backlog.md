...
| JCB-030 | Composite-gcd frontier: FIRST CONTACT DONE (EXP-026: (18, <= 27) certified empty for all a != 0 at h = x^4 y^5; h-sweep empty; gcd-12 probe empty). gcd-12 certificate DONE (EXP-027: -80 a^2 at (24, <= 36)). Next: slice widening, windows past 27/36, beyond-Moh design (gated on JCB-031) | P5 | in-progress | 2026-07-21 | both uncovered composite gcds certified on pure slices |
