...
| JCB-038 | Staircase transport INSTRUMENTED (EXP-037): block-triangular classes, executable transport chain, obstruction at the constant's class, generic -2a = 0 on the minimal family. NEXT: cleared all-parameter certificates + annihilation re-instantiation = THEOREM 5 | P5 | doing | 2026-07-22 | the open core, now with the right instrument |
...
| JCB-040 | THE LIVE FRONTIER (from EXP-040 recalibration): attack GGV's B = 16 normal form (J. Algebra 471 (2017) Cor 7.13 / Thm 8.12: explicit directions + reduced shape) with the transport machine + pair efficiency; then the (72, 108) = ((8,28),(3,2)) system (GGHV 2204.14178, left open for compute): closing it raises the JC(2) floor to 125 | P5 | todo | 2026-07-22 | routes-2026-07-22.md R4 |
| JCB-041 | Integration debt: manuscript + wiki 04 rewrite with the recalibrated floor (replication labels, Magnus 1955 citation, no Zoladek), the novelty-candidate phrasing (Felipe validates), and the EXP-041 witness section; web bake + screenshot pass for the seven new records | P6 | todo | 2026-07-22 | blocks publication gate |
