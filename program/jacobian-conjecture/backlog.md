...
| JCB-033 | THEOREM 2 mostly proved (EXP-030/031): lower-weight perturbations never rescue (absorption + annihilation; kernels = P_top^k). Remaining: the annihilation lemma in closed form [D]; then weight >= v perturbations (the top edge deforms) | P5 | in-progress | 2026-07-22 | dense-polygon families excluded at all degrees |
