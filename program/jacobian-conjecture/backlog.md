...
| JCB-038 | THEOREM 6 (universal tower, EXP-049): all-degree exclusions from single certified windows on the non-proper-power stratum; Theorem 5 unconditional (EXP-046). RESIDUAL: the general half-plane construction for proper-power tops (EXP-048 named the mechanism) | P5 | doing | 2026-07-22 | one construction from full closure |
