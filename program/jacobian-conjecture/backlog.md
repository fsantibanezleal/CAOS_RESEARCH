...
| JCB-033 | The multi-edge calculus: non-monomial slices (P = x + a h^2, h binomial; the EXP-025 lower-term slices): process edges in weight order, each contributing a banded class; prove upper-triangularity of the edge filtration so the top-edge obstruction survives perturbation | P5 | todo | 2026-07-21 | the next reasoning step toward JC(2) |
