...
| JCB-030 | Composite-gcd frontier: FIRST CONTACT DONE (EXP-026: (18, <= 27) certified empty for all a != 0 at h = x^4 y^5; h-sweep empty; gcd-12 probe empty). Next: gcd-12 certificate, slice widening, windows past 27, beyond-Moh degrees | P5 | in-progress | 2026-07-21 | first exclusions outside the gcd-coverage theorems |
| JCB-031 | Rigidity novelty + Moh coverage: bounded search DONE (no statement found; adjacent Newton-polygon and real-JC work); full-text pass of Moh 1983 and the polygon literature before the manuscript calls rigidity new | P3 | in-progress | 2026-07-21 | honesty gate for the manuscript |
