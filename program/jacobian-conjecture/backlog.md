...
| JCB-038 | THEOREM 5 UNCONDITIONAL for primitive tops / d >= u+v (EXP-046: TOWER LEMMA PROVED). Remaining: proper-power odd-resonance derivation; then the general-staircase induction (route M2) | P5 | doing | 2026-07-22 | major milestone landed |
...
| JCB-040 | Frontier pipeline VALIDATED at target scale (EXP-047: (48, <= 64) certificates in 2.4-3.6 s). NEXT: (72,108) + beyond-150 shape transcription and systematic filtered sweeps | P5 | doing | 2026-07-22 | seconds per certificate |
