...
EXP-064 decides that finite ambiguity exactly. All 16 carrier matrices have
certified rational ranks and elementary 2-primary torsion. The two endpoint
triangles vanish integrally in mask 58; every remaining triangle generates
its complete 2-primary subgroup. Masks 59/62 are completely generated by all
triangles, while mask 56 is trivial through p=10 and generated only by
`(2,3,4)` at p=11.

Next mathematical order: finish HWB-081/HWB-069 constructively with uniform
integral sources and transformed duals for those two endpoints; then HWB-085's
...
| HWB-069 | 1 | in progress | derive a signed normal form for the persistent twelve-atom isolated sector | EXP-064 gives exact finite elementary 2-primary types and triangle generators; a uniform constructive normal form remains open |
...
| HWB-081 | 1 | in progress | construct explicit maps between the full triangle family and isolated/relative presentations | EXP-064 proves the finite endpoint images vanish integrally and classifies all tested 2-primary carriers; now construct uniform sources/duals and keep `56->58` separate |
...
| HWB-087 | 1 | done | exact finite carrier 2-primary classification | EXP-064 proves elementary 2-primary types for masks 56/58/59/62 at p=8..11 and upgrades the complete triangle comparison to an integral theorem; independent 1,100-rank audit passes |
