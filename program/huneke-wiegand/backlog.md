...
| HWB-048 | 1 | in progress | repository promotion and durable handoff for EXP-031 plus v0.18 | promote the exact tested research state through separate PRs to `develop` and `main`; defer the scoped CAOS_MANAGE ledger while that checkout is occupied |
