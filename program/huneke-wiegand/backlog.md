...
| HWB-063 | 1 | in progress | repository promotion and durable handoff for EXP-036 plus v0.23 | repository checks pass; promote the verified theorem/publication payload by separate PRs to `develop` and then `main` |
