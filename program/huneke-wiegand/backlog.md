...
| HWB-061 | 1 | pending | all-parameter anatomy of the EXP-035 factor-two torsion | require a fresh declared experiment and finite-target preflight; do not extrapolate the `p=4` Smith factor |
