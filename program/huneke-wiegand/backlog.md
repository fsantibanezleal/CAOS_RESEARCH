...
| HWB-050 | 1 | in progress | manuscript and Zenodo update for the complete cubic-colon Betti polynomial | 43-page v0.19 candidate and exact one-file draft pass; publish Zenodo draft `22031481`, verify concept-latest and fresh public download, then persist the immutable publication record |
