...
| HWB-050 | 1 | in progress | manuscript and Zenodo update for the complete cubic-colon Betti polynomial | expand the existing main manuscript in place to v0.19, run claim/build/render/authorship gates, and publish only after exact draft validation |
