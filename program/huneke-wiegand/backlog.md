...
| HWB-070 | 1 | in progress | certify the rational ranks and complete finite 2-primary torsion of the isolated sector | use distinct-prime modular ranks plus a Hadamard determinant bound to prove `rank_Q=rank_GF(3)` without a full Smith computation |
