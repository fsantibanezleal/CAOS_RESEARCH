...
| HWB-044 | 1 | in progress | manuscript and Zenodo update for the cubic-colon idealization theorem | expand the existing main manuscript to v0.17, run full claim/build/render/authorship gates, then publish and fresh-download verify only if every gate passes |
