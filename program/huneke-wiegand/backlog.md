...
| HWB-035 | 2 | in progress | interior graded Betti table of the conductor fiber cone | EXP-027/028 complete the second row; EXP-029/030/031 complete the third row and internal degree five; higher rows and the remaining table stay open |
...
| HWB-050 | 1 | in progress | manuscript and Zenodo update for the complete cubic-colon Betti polynomial | 43-page v0.19 candidate passes local claim/build/render/authorship/repository gates; commit and push the exact PDF, then upload, validate, publish, and fresh-download verify Zenodo draft `22031481` |
