...
| HWB-064 | 1 | in progress | derive or refute a quasipolynomial law for the `t=2` connecting-parity defect | EXP-037 tests forced values `e_10=73`, `e_11=104` and seeks an integral unit matching indexed by the candidate period-six lattice count |
