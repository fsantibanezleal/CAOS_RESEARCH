...
| HWB-065 | 1 | in progress | test whether the first discrepancy is a degree-six relation in the parity-defect module | EXP-038 predicts the genuinely new value `e_11=102` from numerator correction `-x^6`; an explicit relation remains mandatory for any structural claim |
