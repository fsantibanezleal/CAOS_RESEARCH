...
| HWB-032 | 1 | in progress | companion manuscript and Zenodo record for the curvilinear theorem | split gate passed; build and audit a focused preprint, then publish only after complete validation |
