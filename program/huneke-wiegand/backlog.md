...
| HWB-071 | 1 | in progress | isolate the uniform signed circuit that carries the persistent 2-primary torsion | EXP-044 proves `D:B` and `K:C0` are necessary but their union is insufficient; enumerate the six-row-atom subset lattice before a parameterized integral matching |
