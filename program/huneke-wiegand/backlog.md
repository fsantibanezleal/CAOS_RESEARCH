...
| HWB-004 | 1 | in progress | reproduce published `F<69` frontier | EXP-004 tree enumeration plus checked DRAT proofs |
| HWB-005 | 1 | declared, gated | extend minimal Frobenius frontier | EXP-005 selector CNF, checked proofs, tree cross-check, honest cap |
