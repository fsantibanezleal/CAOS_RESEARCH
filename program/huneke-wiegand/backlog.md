...
| HWB-060 | 1 | in progress | repository promotion and durable handoff for EXP-035 plus v0.22 | promote the verified work-branch payload through separate PRs to `develop` and then `main`; no research release tag |
