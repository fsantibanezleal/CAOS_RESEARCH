...
| HWB-035 | 2 | in progress | interior graded Betti table of the conductor fiber cone | EXP-027--031 complete the second and third homological rows; EXP-033 proves the cubic cone minimal and completes the regularity-three/four strands; the two lower strands of `P_p/Q_p` remain open |
...
| HWB-053 | 1 | in progress | manuscript and Zenodo update for the minimal-cone theorem | expand the existing main manuscript to v0.20; pass claim/build/render/authorship/metadata gates; publish only after exact draft validation |
| HWB-054 | 1 | pending | repository promotion and durable handoff for EXP-033 plus v0.20 | separate PRs from the research work branch to `develop`, then `develop` to `main`, after publication and repository gates pass |
