...
| HWB-061 | 1 | in progress | all-parameter anatomy of the EXP-035 factor-two torsion | EXP-036 declared: exact `p=5,6` propagation screen plus compact integral-core recognition; no extrapolation from `p=4` |
