...
| HWB-069 | 1 | in progress | derive a signed normal form for the persistent twelve-atom isolated sector | extract the parameterized signed incidence blocks, perform exact matched-block cancellation, and identify the integral source of defects `3,4,5,7` before any further coefficient sweep |
