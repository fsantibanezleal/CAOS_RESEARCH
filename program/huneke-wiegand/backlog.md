...
| HWB-047 | 1 | in progress | manuscript and Zenodo update for the complete third row | expand the existing main manuscript to v0.18, run full claim/build/render/authorship gates, then publish and fresh-download verify only if every gate passes |
