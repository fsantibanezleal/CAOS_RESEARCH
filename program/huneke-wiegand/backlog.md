...
| HWB-051 | 1 | in progress | repository promotion and durable handoff for EXP-032 plus v0.19 | promote the exact tested and published work state through separate PRs to `develop` and `main`; defer CAOS_MANAGE ledger reconciliation while that checkout is occupied |
