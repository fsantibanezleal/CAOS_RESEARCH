...
| HWB-054 | 1 | in progress | repository promotion and durable handoff for EXP-033 plus v0.20 | publication and repository gates pass; promote by separate PRs from the research work branch to `develop`, then `develop` to `main` |
