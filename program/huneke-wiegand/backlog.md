...
| HWB-027 | 1 | in progress | extremal presentation-ring Betti data | EXP-024 declared; exact proof, campaign, and independent audit required |
| HWB-028 | 1 | pending | manuscript and Zenodo update for homological edge theorem | open only if EXP-024 is confirmed and claim/build/render QA passes |
