...
| HWB-043 | 1 | in progress | cubic-colon idealization and degree-six third strand | EXP-030 declared: test the canonical-idealization colon and `beta_(3,6)=8p(7p^2-12p+2)/3` through independent integral relative homology |
