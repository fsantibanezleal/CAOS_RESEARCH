...
| HWB-071 | 1 | in progress | isolate the uniform signed bridge that carries the persistent 2-primary torsion | EXP-044 tests exact `D:B` and `K:C0` row projections before a parameterized integral matched-block reduction; neither pivot representative is treated as canonical |
