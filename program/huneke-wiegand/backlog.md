...
| HWB-062 | 1 | in progress | manuscript and Zenodo update for EXP-036 | update the coherent main manuscript to v0.23; pass claim/build/render/authorship/draft/publication/fresh-download gates |
| HWB-063 | 1 | pending | repository promotion and durable handoff for EXP-036 plus v0.23 | after Zenodo publication, pass repository checks and promote by separate PRs to `develop` and then `main` |
