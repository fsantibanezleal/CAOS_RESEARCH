...
| HWB-009 | 0 | done | manuscript and Zenodo | v0.04 published and verified at `10.5281/zenodo.21876338`; all earlier versions remain frozen |
...
| HWB-014 | 1 | in progress | exact trace/conductor ideal across the explicit family | EXP-013 predicts a common four-block ideal of colength `p+1`; equality alone is automatic from the Gorenstein/reflexive criterion |
