...
| HWB-071 | 1 | in progress | isolate the uniform signed circuit that carries the persistent 2-primary torsion | EXP-045 enumerates all 64 subsets of the six row atoms after EXP-044 refutes the two-atom carrier; integral matching waits for the minimal carrier antichain |
