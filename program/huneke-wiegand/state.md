...
Still open: a uniform **integral** comparison to the relative-completion
...
relations do not prove integral vanishing. Next rank is exact all-parameter
witnesses and transformed duals for the two named endpoint triangles, then the
upper bound, then structural parameter transport. No EXP-064 is declared.
