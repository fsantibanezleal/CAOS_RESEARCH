...
| RH-017 | EXP-007: retain the spectral Gram defect through Hilbert-dimension parity compression and test the strict short-interval gain | declared; source preflight and hypothesis must be committed before computation | P0 |
