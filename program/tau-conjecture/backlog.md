...
| TCB-005 | Canonicalization lemmas for polynomial SLP enumeration (normalization, sign symmetry, value-multiset dedup soundness) | todo | P1 | TC-P1 prerequisite; must be PROVED, not assumed, before pruned counts are called exact |
