...
| CCB-029 | Install gfan 0.7 (WSL, binary + hash recorded); reproduce the JL25 n = 5 prevariety one-liner; validate both published f-vectors ((3586,...) and (1506,...)); then HJ11's spatial f-vector | instrument | todo | 2026-07-24 | entry rung for the tropical lane |
