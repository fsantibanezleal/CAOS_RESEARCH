...
| NS-002 | Obtain the two Cordoba-Martinez-Zoroa primary sources ([5] and [6] of the Boussinesq paper) and read the layer organization at implementation level | research | done (in part) | P0 | M | none | n/a |
