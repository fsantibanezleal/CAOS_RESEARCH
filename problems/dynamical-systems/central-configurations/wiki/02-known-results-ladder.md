...
| $n = 6$ planar | OPEN. The published abstract reports 117 candidate zw-diagrams, 31 eliminated by the second algorithm and 62 by the last; the residual count of 24 is OUR arithmetic from those numbers, not a quoted statement | Chang-Chen, J. Symbolic Comput. 123 (2024) 102277 (part I; data pinned via the Jensen-Leykin reference list); programme preprint arXiv:2303.02853 |
