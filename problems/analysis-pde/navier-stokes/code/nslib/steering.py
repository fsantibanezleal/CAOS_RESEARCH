...
THE PDE REALIZATION lives in `nslib.corotating`, which is kept separate so that this
module stays free of torch and can be exercised by repository CI. A rigid rotation of the
background does not fit on a torus. In two
