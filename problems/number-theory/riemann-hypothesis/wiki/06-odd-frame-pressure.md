# 6. Odd-frame pressure refinement of the short-interval cosine bound
This chapter transcribes the complete [EXP-003 proof](../experiments/EXP-003-odd-frame-pressure/mathematical-proof.md).
Its [confirmed verdict](../experiments/EXP-003-odd-frame-pressure/verdict.md),
[adversarial audit](../experiments/EXP-003-odd-frame-pressure/adversarial-audit.md),
and [exact results](../experiments/EXP-003-odd-frame-pressure/artifacts/result.json)
are the authoritative evidence. Chapter 3 retains the first released derivation.
...
This section rechecks the [EXP-002 finite argument](../experiments/EXP-002-short-interval-stability/mathematical-proof.md).
