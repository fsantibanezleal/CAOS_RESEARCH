...
This chapter transcribes the [EXP-002 proof](../experiments/EXP-002-short-interval-stability/mathematical-proof.md).
Its [verdict](../experiments/EXP-002-short-interval-stability/verdict.md) and
[independent adversarial audit](../experiments/EXP-002-short-interval-stability/adversarial-audit.md)
are the authoritative experiment records. The [Wang transfer dossier](../context/2026-09-12-wang-transfer-audit.md)
spells out the fixed-test error and deweighting interface.
...
The root nonadditivity is prior work in the
[Ainta proof](https://github.com/ainta/zeta-simple-zeros/blob/040c5e899e658aed7b56a2a87f501798fe10761d/docs/proof.md).
The argument below reproduces it and supplies the explicit conservative
bound used by the present short-interval theorem.
...
- [Lamzouri, arXiv:2609.02882v2](https://arxiv.org/html/2609.02882v2): finite
  ...
  smooth deweighting. Proposition 2.1 and Lemmas 3.1 and 3.2.
- [Wang, arXiv:2609.07918v1](https://arxiv.org/html/2609.07918v1): the
  ...
  2.2; Lemma 3.1.
- [Ainta stability manuscript](https://github.com/ainta/zeta-simple-zeros/blob/040c5e899e658aed7b56a2a87f501798fe10761d/paper/riemann.tex):
  stable rank-trace inequality and Gram-defect/pinching method. These are
  prior work; they are not claimed as new here.
- [trmdy contributor manuscript](https://github.com/trmdy/zeta-simple-zeros-673137/blob/1610b97b7895ff34982260f8dcaf04a0f7b82cf7/paper/main.tex):
...
[Previous: established results](02-known-results.md) | [Next: experiments and reproduction](04-experiments.md)
