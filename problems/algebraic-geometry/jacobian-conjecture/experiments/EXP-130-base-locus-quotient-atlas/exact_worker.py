"""Exact block-determinant reconstruction for the EXP-130 selected basis."""
...
spec = importlib.util.spec_from_file_location("exp125_exp130_worker", E125_PATH)
...
def main() -> None:
    ...
    payload = {
        "experiment": "EXP-130-exact-worker",
    ...
    print(f"[PASS] exact worker SHA256 {sha256(ARTIFACT)}", flush=True)
