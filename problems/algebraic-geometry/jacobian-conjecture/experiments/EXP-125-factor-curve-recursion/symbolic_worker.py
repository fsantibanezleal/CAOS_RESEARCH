"""Timeout-isolated exact F3-basis determinant worker for EXP-125."""
...
spec = importlib.util.spec_from_file_location("exp125", RUN_PATH)
...
def main() -> None:
    ...
    rows = checkpoint["selected_rows"]["F3"]
    anchor_point = checkpoint["F3_anchor"]["point"]
