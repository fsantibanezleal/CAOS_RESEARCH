...
The new manuscript is planned at `manuscripts/bougard-joret/next-matching/`, version 0.01. Its Zenodo publication is pending. The separate first-shell manuscript remains frozen at [published v0.02](https://doi.org/10.5281/zenodo.22341644) in `manuscripts/bougard-joret/tree-strip/`.
