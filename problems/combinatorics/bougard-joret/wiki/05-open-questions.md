...
The proven strict-interior obstruction is the explicit EXP-003 bracket; the questions above are the remaining scope. Read the [next-matching source review](../context/2026-09-05-next-matching-review.md), which extends the [earlier September 5 portfolio refresh](../context/2026-09-05-portfolio-refresh.md), before selecting another problem. The first-shell manuscript v0.02 is preserved. The separate next-matching manuscript v0.01 is [published](https://doi.org/10.5281/zenodo.22343022), with public-byte verification complete; only its scoped integration remains pending. The full AEY conjecture and general revised Bougard-Joret problem remain open.
