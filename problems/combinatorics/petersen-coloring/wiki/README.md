...
| EXP-006 | CONFIRMED as redirected | parity THEOREM: the Petersen defect is never 1; G52: all 52 singles refuted, all 1,326 pairs critical (defect exactly 2); G112, H112: all 120 free-vertex pairs critical (defect exactly 2); full 6,216-pair sweeps and the G52 edge sweep running |
