...
## 2026-09-20 - EXP-064 exact finite integral comparison confirmed

- Sixteen modular-Hadamard certificates prove the exact carrier rational ranks.
  Every rational/mod-two rank gap equals the first-Bockstein rank, so masks
  56/58/59/62 have only elementary 2-primary torsion at `p=8,...,11`.
- The two mask-58 endpoint triangles therefore vanish integrally, while every
  other triangle generates its complete 2-primary subgroup. Masks 59/62 are
  completely generated by all triangles. Mask 56 is trivial through p=10 and
  generated by `(2,3,4)` at p=11.
- The independent audit verifies 1,100 prime/rank pairs, 16 minimal Hadamard
