...
| [07 the three worlds](07-three-worlds.md) | F_p / R / Z ladders on the same programs; the 2^(tau-1) theorem; the golden-ratio witness; multiplicity vs distinctness | transcribed 2026-08-25 |
| 08 experiments index | One line per EXP-NNN with verdicts | current (below) |
...
| [EXP-013](../experiments/EXP-013-additive-residual/) | Nine-gate seven-rooter via a final $\pm$? | **CONFIRMED, windowed**: all 1,048,460,912 states, 1,272,725 exact checks, zero seven-rooters with roots in $[-32,32]$; a witness would need $|c| \ge 396$ (the 0.002% residual of EXP-014) |
