...
Write $a$ for the prescribed independence number. Our main result is the following.
...
The stronger complete tree characterization is Theorem~\ref{thm:main} below.
