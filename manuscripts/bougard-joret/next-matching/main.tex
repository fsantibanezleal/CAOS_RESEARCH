...
\newcommand{\versiondoi}{10.5281/zenodo.22835084}
\newcommand{\conceptdoi}{10.5281/zenodo.22343021}
...
\fancyhead[R]{\small Next matching level\textperiodcentered\ \docversion}
\fancyfoot[C]{\thepage}
...
Our universal deductions are labeled [D] and exact finite checks [MV]. The proof and certificates are archived as computation EXP-003~\cite{Record}. The first interior shell of the Bougard--Joret problem is the subject of the companion paper~\cite{Shell}.
...
\]
The shortcut fails because extremality under a degree bound does not supply the needed complement connectivity.

\section{Exact checks, scope and remaining questions}

The universal assertions follow from the proofs above. EXP-003~\cite{Record} additionally contains deterministic exact verification for $d=7,\ldots,30$.
...
The proof, the review of the cited sources, the certificate generators, the independent re-implementation and the full edge lists are publicly archived in the repository~\cite{Record}. The identifier EXP-003 denotes the archived computation in the folder \path{problems/combinatorics/bougard-joret/experiments/EXP-003-triangle-free-next-matching/}.

\paragraph{Declaration of generative AI use.} Generative AI tools were used for literature triage, derivation exploration, code drafting and internal review of the proofs and the text. The author reviewed and verified all content and takes full responsibility for the work.
...
\bibitem{Shell} F. Santib\'a\~nez-Leal.
\emph{The first interior shell of the Bougard--Joret extremal problem}.
CAOS Research preprint, 2026.
\href{https://doi.org/10.5281/zenodo.22315251}{doi:10.5281/zenodo.22315251}.
\bibitem{Record} F. Santib\'a\~nez-Leal.
\emph{CAOS Research, Bougard--Joret EXP-003: triangle-free next matching level}.
Proof, source review, exact certificates and independent re-implementation, 2026.
\href{https://github.com/fsantibanezleal/CAOS_RESEARCH/tree/main/problems/combinatorics/bougard-joret/experiments/EXP-003-triangle-free-next-matching}{Public experiment record}.
\end{thebibliography}
\end{document}
