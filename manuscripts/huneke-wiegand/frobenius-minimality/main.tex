...
\hypersetup{
  pdftitle={Frobenius Minimality and Minimum-Layer Uniqueness of the Huneke--Wiegand Counterexample},
  pdfauthor={Felipe Santibanez-Leal},
  pdfsubject={Certified Frobenius-minimality and minimum-layer classification for a two-generated monomial-ideal counterexample},
...
\title{Frobenius Minimality and Minimum-Layer Uniqueness\\
of the Huneke--Wiegand Counterexample}
...
\fancyhead[R]{\small Frobenius Minimality and Uniqueness \textperiodcentered\ v0.02}
...
First paper of the Huneke--Wiegand extension record \textperiodcentered\ version 0.02 \textperiodcentered\ 2026-08-02\\
Concept DOI \href{https://doi.org/10.5281/zenodo.21763582}{10.5281/zenodo.21763582} (resolves to latest) \textperiodcentered\ this version: \href{https://doi.org/10.5281/zenodo.21764868}{10.5281/zenodo.21764868}\\
...
verified it. This paper contributes certified Frobenius-minimality and minimum-layer uniqueness.
}}
\end{center}
...
the Frobenius minimum in this class. The result does not classify higher Frobenius values or
...
is independent external evidence. The contributions proved here are Frobenius minimality and
uniqueness of the normalized pair at that minimum in the specified semigroup/ideal class, together
with their reproducible certificate suites.

Theorems~\ref{thm:minimal} and~\ref{thm:unique} do not classify higher Frobenius values, prove a
minimum multiplicity or embedding dimension across all counterexamples, or establish minimality
among arbitrary Gorenstein domains and modules. The following questions remain open:
\begin{enumerate}
