...
the real ladder is not merely the Chebyshev ladder, which buys a doubling per
three gates ($T_2 = 2x^2-1$ costs three, and composition repeats it) and would
give only four roots here.
