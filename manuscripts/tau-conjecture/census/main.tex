...
fixed before production ($61$-bit primes overflow \texttt{int64} under modular
multiplication, and identically-zero polynomials agree at every window point,
excluded rigorously since a nonzero polynomial of degree below $65$ cannot
vanish at $65$ points).
