...
$\zrmax(1..5) = 1,2,3,4,6$ [MV] and the integer census stays linear. What limits
...
\tau            & 1 & 2 & 3 & 4 & 5 & 6 & 7 & 8\\\hline
\zmax(\tau)     & 1 & 2 & 3 & 3 & 4 & 5 & 5 & 6\\
\zrmax(\tau)    & 1 & 2 & 3 & 4 & 6 & \text{--} & \text{--} & \text{--}\\
\zpmax(\tau)    & 1 & 2 & 4 & 8 & 16 & 32 & 64 & 128
\end{array}
\]
(The real row is exhaustive through $\tau = 5$; extending it needs the
$25.8$M-state frontier resident, which we defer.) The three worlds separate at
...
We claim no rate for $\zrmax$: five points cannot distinguish
$\Theta(2^{\tau/3})$ from anything nearby, and the paper needs only the known
