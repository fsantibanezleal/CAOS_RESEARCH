...
Both counts are tight against the model's conventions because the programs are
run as data, not counted by hand. Witness (A) costs nothing extra for its
...
and the two come out equal at ten gates. Across the entire exhaustive range
($z \le 6$) the minimal-gate root sets are intervals. The census therefore ends
