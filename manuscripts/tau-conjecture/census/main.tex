...
frontier enumerates all $134{,}497$ new $\tau = 6$ polynomials in $180$\,s, and
...
compute for every result in this paper is under twenty hours on one desktop
machine (24 cores; the depth-8 pipeline used 20 processes and $\sim$29 GB of
scratch disk; peak RAM $\sim$12 GB). The constructed depth-7 frontier
($1{,}048{,}460{,}912$ states, 28 GB) and the polynomial catalog are retained
as reusable data assets with hashes recorded in the repository.
