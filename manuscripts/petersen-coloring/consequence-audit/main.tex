...
\newcommand{\versiondoi}{10.5281/zenodo.22835152}
...
witnesses, slowest $20$ seconds), and the same holds for every one of the $1{,}326$ pairs of
$\Gftyb$ and of the $2{,}278$ pairs of $\Gsix$ (computation EXP-008). The checker reports exactly
the two relaxed vertices as bad in all $17{,}362$ pair witnesses of the five graphs. We call this
property, verified here for the five graphs and unexplained by the parity argument,
\emph{universal 2-criticality}. In every one of the $1{,}326$ witnesses of $\Gfty$ the vectors
$\chi_u$, $\chi_v$ of the two bad vertices lie in the same nonzero class modulo the cut space of
$\PG$, as the argument above requires; in $1{,}279$ of them this is the class of a single edge of
$\PG$.
...
in~\cite{MMM2021} for that class does not force bad vertices by itself: for $\Gfty$, $\Gftyb$ and $\Gsix$,
every 4-pole obtained by deleting two independent edges has a Petersen coloring (one
representative per orbit of edge pairs, 482, 482 and 4{,}947 4-poles, computation EXP-010), and the boundary
labels of the colorings found are of two kinds only, as the cut space predicts: two crossed equal
pairs, or the four edges adjacent to one edge of $\PG$. A 4-pole with a crossed pattern can be chained around a ring with an even number of copies,
because any two edges of $\PG$ are exchanged by an automorphism, so these cyclic joins are
Petersen colorable. In all 73 4-poles of $\Gfty$ that contain a fixed deleted edge, the two
labels at the ends of that edge can be chosen adjacent in $\PG$. Ten dot products of $\Gfty$ with itself, cubic graphs on 102 vertices, have no Petersen coloring (checked proofs) and defect exactly~2.
