...
6-edge-colorings and the exact defects, Section~\ref{sec:compositions} the compositions of
...
\begin{proof}
The matchings are explicit (the repository file \texttt{witnesses.json} of computation EXP-002
lists them as edge index sets) and were re-verified by a checker that tests each set to be a perfect
...
Section~\ref{sec:normal} on EXP-004 and EXP-006, and Section~\ref{sec:compositions} on EXP-005.
\par}
