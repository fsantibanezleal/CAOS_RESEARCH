...
\fancyhead[R]{\small Planar Keller Maps \textperiodcentered\ v0.15}
...
Paper B of a three-paper record \textperiodcentered\ version 0.15 \textperiodcentered\ 2026-07-25\\
...
Priorities, from the standing routes evaluation: (1) attempt a low-cost,
typed transport of the seven inner-vertex alternatives or the intersection
number $21$ into the $51$ reduced coefficients, stopping if the normalization
does not preserve the chosen invariant; (2) compute the small
certificate-module/chart cover---left syzygies of $M$, their pairing ideal
with the right-hand side, and localized certificates---rather than extending
one-sided support sweeps; (3) pursue Newton resolution only after deriving a
