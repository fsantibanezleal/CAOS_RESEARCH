...
\date{2026-07-31\\[2pt]\normalsize Version 0.28}

\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small CAOS Research Preprint}
\fancyhead[R]{\small Planar Keller Maps \textperiodcentered\ v0.28}
...
atlas closes the entire \(AS\ne0\) rational graph. The finite base locus and
\(A=0\) remain.
...
The finite base locus \(V(R,S)\) and the separate divisor \(A=0\) remain, as
do the full four-parameter restriction, the \((72,108)\) case, the planar
degree floor, and \(JC(2)\).
...
EXP-124--129 closure of the \(AS\ne0\) rational graph and treat the finite
base locus \(V(R,S)\) and the separate \(A=0\) boundary in independent
experiments; (2) retain the complete EXP-118--121 \(T_B\) cover as a
