...
\date{2026-08-01\\[2pt]\normalsize Version 0.31}

\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small CAOS Research Preprint}
\fancyhead[R]{\small Planar Keller Maps \textperiodcentered\ v0.31}
...
Paper B of a three-paper record \textperiodcentered\ version 0.31 \textperiodcentered\ 2026-08-01\\
...
parameter substitution into the old atlas. This result does not close the
\(A\ne0,d=1\) lift, the transverse \(d=0\) quotient, the complete
five-coefficient restriction, or any larger target.
...
fifth-direction lift and the transverse \(d=0\) kernel quotient remain open;
...
five-coefficient unit-ideal identity; (2) lift the fifth direction \((2,8)\)
through the EXP-123/124/129/130 \(A\ne0,d=1\) atlas, selecting sections by
SCC structure and reducing their joint exceptional ideal before attempting
generic multivariate determinants; (3) rebuild the transverse \(d=0\)
