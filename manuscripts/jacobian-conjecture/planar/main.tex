...
\date{2026-07-31\\[2pt]\normalsize Version 0.29}

\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small CAOS Research Preprint}
\fancyhead[R]{\small Planar Keller Maps \textperiodcentered\ v0.29}
...
Paper B of a three-paper record \textperiodcentered\ version 0.29 \textperiodcentered\ 2026-07-31\\
...
declared four-parameter restriction is covered. The direct boundary \(A=0\)
remains.
...
Only the direct divisor \(A=0\) remains for the declared four-parameter
restriction. The 24-parameter core, complete 51-parameter family,
\((72,108)\) case, planar degree floor, and \(JC(2)\) remain open.
...
EXP-124--130 closure of the complete \(A\ne0\) sector and specialize the
original augmented matrix directly at \(A=0\), before invariant division;
(2) profile its generic rank over \(\Q(B,C)\), then combine a finite pivot
atlas with an independent module/Fitting or polynomial-matrix
invariant-factor calculation; (3) retain the complete EXP-118--121 \(T_B\)
