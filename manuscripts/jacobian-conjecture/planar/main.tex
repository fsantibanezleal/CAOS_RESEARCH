...
\fancyhead[R]{\small Planar Keller Maps \textperiodcentered\ v0.18}
...
Paper B of a three-paper record \textperiodcentered\ version 0.18 \textperiodcentered\ 2026-07-26\\
...
two-coefficient GGHV slice exactly. On the residual curve, two normalized
maximal minors reduce, with \(z=u^9\), to
\(21-96z-1024z^2\) and \((8z+1)^{14}\); a persisted integer Bezout identity
has constant \(17^{14}\). A connected mod-9 row/column grading extends to
every nonconstant direction in the persisted lower family. This is a strict
slice result and does not exclude the full \((72,108)\) family.
...
actual GGHV coefficient slice and expose a global lower-family grading. They
do not cover simultaneous variation of the other coefficients, exclude the
full \((72,108)\) family, or raise the degree floor.
...
Priorities, from the standing routes evaluation: (1) lift the exact EXP-105
cover through the promoted \((0,7)\) coefficient using
\(z=u^9,\ y=v/u\), reconstruct the bivariate minors on graded NTT grids, and
compute their common-zero ideal before selecting new charts; (2) reopen the intersection-$21$ transport only
