...
\date{2026-07-30\\[2pt]\normalsize Version 0.27}

\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small CAOS Research Preprint}
\fancyhead[R]{\small Planar Keller Maps \textperiodcentered\ v0.27}
...
90 lifts. Thus no positive-dimensional factor curve remains on this graph
chart. The finite graph ledger, the finite base locus, and \(A=0\) remain.
...
The 102 normalized finite graph values (306 lifts before overlap analysis),
the finite base locus, and the separate divisor \(A=0\) remain, as do the
full four-parameter restriction, the \((72,108)\) case, the planar degree
floor, and \(JC(2)\).
