...
\date{2026-07-30\\[2pt]\normalsize Version 0.25}

\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small CAOS Research Preprint}
\fancyhead[R]{\small Planar Keller Maps \textperiodcentered\ v0.25}
...
Paper B of a three-paper record \textperiodcentered\ version 0.25 \textperiodcentered\ 2026-07-30\\
...
points. The curves \(F_6,F_7\), the finite base locus, and \(A=0\) remain.
...
not a complete four-parameter cover. The graph curves \(F_6,F_7\), the
...
recursive graph atlas from the \(F_3\) finite reduction to exact quotient-ring
covers of \(F_6\) and \(F_7\), followed by the finite graph/base-locus points
