...
\date{2026-07-30\\[2pt]\normalsize Version 0.24}

\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small CAOS Research Preprint}
\fancyhead[R]{\small Planar Keller Maps \textperiodcentered\ v0.24}
...
Paper B of a three-paper record \textperiodcentered\ version 0.24 \textperiodcentered\ 2026-07-30\\
...
constructible-cover method beyond the now-closed three-parameter \(T_B\)
restriction to a restriction that adds genuine coverage of the 24-parameter
cyclic core; (2) retain the complete EXP-118--121 \(T_B\) cover as a
