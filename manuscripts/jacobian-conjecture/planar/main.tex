...
\date{2026-07-31\\[2pt]\normalsize Version 0.30}

\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small CAOS Research Preprint}
\fancyhead[R]{\small Planar Keller Maps \textperiodcentered\ v0.30}
...
Paper B of a three-paper record \textperiodcentered\ version 0.30 \textperiodcentered\ 2026-07-31\\
...
EXP-118/123/129--131 closure of the complete declared four-coefficient
restriction; (2) test a transverse fifth direction, beginning with \((2,8)\),
whose EXP-122 anchor factor is linear and whose union SCC has size 35, and
recurse on the joint exceptional ideal of several exact sections; (3) retain
the complete EXP-118--121 \(T_B\)
cover as a regression gate rather than adding redundant slice charts; (4) retain the
exact EXP-108 lift through \((0,6)\) as a bounded chart control rather than
a terminating programme; (5) reopen the intersection-$21$ transport only
after constructing a complete boundary-divisor ledger through the swap,
Laurent cuts, and final inversion; (6) pursue Newton resolution only after deriving a
condition beyond the already-retained first $D=72$ branch; and (7) retain the
