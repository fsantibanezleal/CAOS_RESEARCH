...
\newcommand{\versiondoi}{10.5281/zenodo.22822774}
...
against its primary source (EXP-001, EXP-016, \mbox{EXP-018}), the counterexample resolves or
...
implications; for each implication the primary source was located and its direction confirmed
(EXP-016 and EXP-018). The corollaries of Section~\ref{sec:cascade} add no mathematics beyond
this verification and the composition of the published implications; the explicit witness of
...
The two-variable Jacobian conjecture; Dixmier at ranks 1 and 2; Mathieu for $SU(2)$ and the
remaining compact groups; the moments statement in dimensions below $3$; the minimal failing
dimensions of the Poisson, vanishing and Image statements (for the symmetric/vanishing pair the
...
its direction confirmed) and EXP-041 (the dimension-48 witness, with its input data, script and
outputs).\par}
