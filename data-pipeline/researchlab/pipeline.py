...
the compact artifact + manifest (CONTRACT 2) and a flat index.json.
    ...
    python -m researchlab.pipeline            # all cases
    python -m researchlab.pipeline EX02_epidemic --seed 7
"""
...
# data-pipeline/researchlab/pipeline.py -> parents[2] = repo root (works under `pip install -e .` too)
...
def main() -> None:
    ap = argparse.ArgumentParser(prog="researchlab.pipeline")
