...
\date{2026-07-22 (working manuscript, v0.06; split from the foundational companion)}
...
egin{theorem}[{[MV/D]}; the half-plane tower (EXP-051)]\label{thm:halfplane}
...
pointed to the perturbative construction $\Lambda(arepsilon)$; its base is sound
...
with identical verdict): the $eta$-symbolic certificates give pairing
$23592960\,eta$ with the degenerate $eta = 0$ corner covered by the stratum
...
The orientation swap is absorbed by $Q 	o -Q$. Stated with its residuals (the
fully-simultaneous interior-symbolic certificate is not computed; the claim rests on
GGHV's Prop.~4.3 as published, transcription verified): 	extbf{no Jacobian pair of
degrees $(72, 108)$ exists; combined with GGHV Thm.~2.1, any counterexample to $JC(2)$
has $\max\deg \ge 125$: the verified floor rises from $108$ to $125$.} The full
evidence chain and residuals: 	exttt{program/jacobian-conjecture/72108-closure-statement.md}.
