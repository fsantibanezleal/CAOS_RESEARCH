...
**CONTRACT 1** (`data-pipeline/researchlab/io/contract.py`).
...
4. **Live (optional):** if the [gate](../architecture/03_the-gate.md) classifies your case `live`, the frontend's
   Pyodide lane calls `researchlab.live.run_trace_json({...your params...})` and renders the result in-browser, no
