// LIVE lane (optional, Pyodide): load the inlined researchlab sources (public/pyodide/sources.json) and call
// researchlab.live.run_trace_json for a bring-your-own-params interaction in the browser. This is a STUB, a real
